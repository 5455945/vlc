            ...
            : QVLCDialog( (QWidget*)_p_intf->p_sys->p_mi, _p_intf ), b_advanced( false )
{
    ...
    ui.title->setText("<html><head/><body><p><span style=\" font-size:26pt; color:#353535;\"> " + qtr( "i@free VLC media player" ) + " </span></p></body></html>");

    ui.MainBlabla->setText("<html><head/><body>" +
    qtr( "<p>i@free VLC media player is a free and open source media player, encoder, and streamer made by the volunteers of the <a href=\"http://www.resmiles.com/\"><span style=\" text-decoration: underline; color:#0057ae;\">i@free</span></a> community.</p><p>i@free VLC uses its internal codecs, works on essentially every popular platform, and can read almost all files, CDs, DVDs, network streams, capture cards and other media formats!</p><p><a href=\"http://www.resmiles.com/contribute/\"><span style=\" text-decoration: underline; color:#0057ae;\">Help and join us!</span></a>" ) +
    "</p></body> </html>");
...
UpdateDialog::UpdateDialog( intf_thread_t *_p_intf ) : QVLCFrame( _p_intf )
{
    ...
    setWindowTitle( qtr( "i@free VLC media player updates" ) );
    ...
    if( b_result )
    {
        ...
        else
        {
            ...
            ui.updateDialogLabel->setText(
                    qtr( "You have the latest version of i@free VLC media player." ) );
        }
    }
    else
    {
